const VisaIcon = ({ className = "h-6" }: { className?: string }) => (
...
const MastercardIcon = ({ className = "h-6" }: { className?: string }) => (
  <svg viewBox="0 0 780 500" className={className} xmlns="http://www.w3.org/2000/svg">
...
const AmexIcon = ({ className = "h-6" }: { className?: string }) => (
  <svg viewBox="0 0 780 500" className={className} xmlns="http://www.w3.org/2000/svg">
...
export const CardBrandLogos = () => (
  <div className="flex items-center gap-2 mt-2 px-1">
    ...
    <AmexIcon className="h-7 w-auto rounded" />
  </div>
);
